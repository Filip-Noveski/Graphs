...
internal class GraphsWithNWCycleBenchmarkingHelper
{
    ...
    public static Graph GraphWith49VerticesAnd69Edges
    {
        get
        {
            ...
            g.CreateEdge(id++, GetId(24), GetId(33), -55);
            ...
            g.CreateEdge(id++, GetId(31), GetId(34), -11);
            g.CreateEdge(id++, GetId(32), GetId(31), Math.Sign(random.NextDouble() - 0.5) * 2);
            g.CreateEdge(id++, GetId(33), GetId(32), Math.Sign(random.NextDouble() - 0.5) * 9);
            ...
            g.CreateEdge(id++, GetId(35), GetId(22), -43);
